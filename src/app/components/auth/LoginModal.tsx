...
import { authLoginSchema, type AuthLoginFormValues } from '@/domain/auth/schemas/authForm.schema';
...
const DEMO_LOGIN_VALUES: AuthLoginFormValues = {
        ...
        <DialogPrimitive.Portal>
          ...
          >
            ...
            <div
              ...
              style={{
                background: 'linear-gradient(135deg, #f3f0ff 0%, #ede9fe 50%, #faf5ff 100%)',
              }}
            >
              <Image
            ...
            <div className='px-6 pb-6 pt-5 space-y-4'>
              ...
              <div className='flex justify-center'>
                ...
                >
                  {serverStatus === 'online' && (
                    <>
                      <Wifi size={11} /> เซิร์ฟเวอร์พร้อมใช้งาน
                    </>
                  )}
                  {serverStatus === 'offline' && (
                    <>
                      <WifiOff size={11} /> ไม่ตอบสนอง — กดลองใหม่
                    </>
                  )}
                  {serverStatus === 'checking' && (
                    <>
                      <RefreshCw size={11} className='animate-spin' /> ตรวจสอบอยู่...
                    </>
                  )}
                  {serverStatus === 'unknown' && (
                    <>
                      <Wifi size={11} /> ตรวจสอบเซิร์ฟเวอร์
                    </>
                  )}
                </button>
              </div>
              ...
              <Form {...form}>
                ...
                >
                  ...
                  {isSubmitting && (
                    <p className='text-center text-[11px] text-gray-400 animate-pulse'>
                      {loadingHint}
                    </p>
                  )}
                </form>
