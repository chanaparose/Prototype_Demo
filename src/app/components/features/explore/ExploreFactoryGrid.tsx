...
export function ExploreFactoryGrid({
  factories,
  onFactoryClick,
  onSeeAll,
}: ExploreFactoryGridProps) {
  return (
    <div className='mx-4 mb-3 rounded-2xl overflow-hidden border border-gray-200 bg-white'>
      ...
      >
        ...
        />
        <div
          className='absolute -top-4 right-8 w-16 h-16 rounded-full blur-2xl opacity-30 pointer-events-none'
