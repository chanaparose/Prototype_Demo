    ...
    <footer className="w-full bg-[#F2F2F2] border-t border-gray-200 pt-6 md:pt-10 mt-8 md:mt-12 flex-shrink-0">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="md:hidden mb-6 space-y-2">
          ...
          >
            <div className="flex flex-col gap-2 max-w-[140px]">
              <a href="#" className="bg-black text-white rounded-lg px-2 py-1.5 flex items-center gap-2 hover:bg-gray-800 transition-colors">
        ...
        <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-7 md:mb-10">
          {/* Col 1 */}
          <div>
            <h3 className="font-bold text-[#292259] mb-2.5 text-sm md:text-base border-b-2 border-[#A656A0] pb-1 inline-block">ศูนย์ดูแลลูกค้า</h3>
          ...
          {/* Col 2 */}
          <div>
            <h3 className="font-bold text-[#292259] mb-2.5 text-sm md:text-base">หมวดหมู่บริการและสินค้า</h3>
          ...
          {/* Col 3 */}
          <div>
            <h3 className="font-bold text-[#292259] mb-2.5 text-sm md:text-base">แหล่งความรู้และคูปอง</h3>
            <ul className="space-y-2 text-[11px] md:text-xs text-gray-600">
              <li><a href="#" className="hover:text-[#A656A0] transition-colors">คูปอง</a></li>
              <li><a href="#" className="hover:text-[#A656A0] transition-colors">ค้นหาสถานที่และบริการ</a></li>
              <li><a href="#" className="hover:text-[#A656A0] transition-colors">บทความ</a></li>
          ...
          {/* Col 4 */}
          <div>
            <h3 className="font-bold text-[#292259] mb-2.5 text-sm md:text-base">ดาวน์โหลดแอปพลิเคชัน</h3>
            <div className="flex flex-col gap-2 max-w-[140px] md:max-w-[150px]">
              <a href="#" className="bg-black text-white rounded-lg px-2 py-1.5 flex items-center gap-2 hover:bg-gray-800 transition-colors">
                <div className="flex-1">
                  ...
                  <div className="text-[11px] md:text-xs font-semibold leading-tight">App Store</div>
                </div>
              </a>
              <a href="#" className="bg-black text-white rounded-lg px-2 py-1.5 flex items-center gap-2 hover:bg-gray-800 transition-colors">
                <div className="flex-1">
                  <div className="text-[8px] md:text-[9px] leading-tight">GET IT ON</div>
                  <div className="text-[11px] md:text-xs font-semibold leading-tight">Google Play</div>
                </div>
              </a>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 py-4 md:py-6 border-t border-gray-300">
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <a href="#" className="w-8 h-8 md:w-9 md:h-9 rounded-full bg-blue-600 text-white flex items-center justify-center hover:bg-blue-700 transition-colors"><Facebook size={16} /></a>
              <a href="#" className="w-8 h-8 md:w-9 md:h-9 rounded-full bg-green-500 text-white flex items-center justify-center hover:bg-green-600 transition-colors"><span className="font-bold text-[10px]">LINE</span></a>
              <a href="#" className="w-8 h-8 md:w-9 md:h-9 rounded-full bg-red-600 text-white flex items-center justify-center hover:bg-red-700 transition-colors"><Youtube size={16} /></a>
              <a href="#" className="w-8 h-8 md:w-9 md:h-9 rounded-full bg-gradient-to-tr from-[#F28A2E] via-[#F27830] to-[#A656A0] text-white flex items-center justify-center hover:opacity-90 transition-opacity"><Instagram size={16} /></a>
            </div>
          </div>
          {/* Shipping */}
          <div>
          ...
          {/* Payments */}
          <div>
            <h4 className="font-bold text-[#292259] mb-2.5 text-xs md:text-sm">ช่องทางการชำระเงิน</h4>
            <div className="flex flex-wrap items-center gap-2.5 opacity-70 grayscale">
