...
export function ExploreFooter() {
  return (
    <footer className="w-full bg-[#F2F2F2] border-t border-gray-200 pt-12 mt-16 flex-shrink-0">
      <div className="max-w-7xl mx-auto px-8">
        {/* Top 4 Columns */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {/* Col 1 */}
          <div>
            <h3 className="font-bold text-[#292259] mb-4 text-lg border-b-2 border-[#A656A0] pb-1 inline-block">ศูนย์ดูแลลูกค้า</h3>
          ...
          {/* Col 2 */}
          <div>
            <h3 className="font-bold text-[#292259] mb-4 text-lg">หมวดหมู่บริการและสินค้า</h3>
          ...
          {/* Col 3 */}
          <div>
            <h3 className="font-bold text-[#292259] mb-4 text-lg">แหล่งความรู้และคูปอง</h3>
            <ul className="space-y-3 text-sm text-gray-600">
          ...
          {/* Col 4 */}
          <div>
            <h3 className="font-bold text-[#292259] mb-4 text-lg">ดาวน์โหลดแอปพลิเคชัน</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 py-8 border-t border-gray-300">
          {/* Socials */}
          <div>
            <h4 className="font-bold text-[#292259] mb-4">ติดตามเรา</h4>
            <div className="flex items-center gap-3">
              ...
              <a href="#" className="w-10 h-10 rounded-full bg-gradient-to-tr from-[#F28A2E] via-[#F27830] to-[#A656A0] text-white flex items-center justify-center hover:opacity-90 transition-opacity"><Instagram size={20} /></a>
            </div>
          </div>
          {/* Shipping */}
          <div>
            <h4 className="font-bold text-[#292259] mb-4">การจัดส่ง</h4>
          ...
          {/* Payments */}
          <div>
            <h4 className="font-bold text-[#292259] mb-4">ช่องทางการชำระเงิน</h4>
            <div className="flex flex-wrap items-center gap-4 opacity-70 grayscale">
