...
/** Flat typography for markdown in showcase detail — body 14px, headings 16px */
export const SHOWCASE_DETAIL_MARKDOWN_CLASS = [
  'max-w-none text-[14px] text-gray-700 leading-relaxed',
  '[&_p]:my-2 [&_p]:text-[14px]',
  '[&_li]:my-1 [&_li]:text-[14px]',
  '[&_ul]:list-disc [&_ul]:my-2 [&_ul]:pl-6 [&_ul]:text-[14px]',
  '[&_ol]:list-decimal [&_ol]:my-2 [&_ol]:pl-6 [&_ol]:text-[14px]',
  '[&_li>ul]:my-1 [&_li>ol]:my-1',
  '[&_td]:text-[14px] [&_th]:text-[14px]',
  '[&_table]:my-3 [&_table]:w-full [&_table]:border-collapse [&_table]:overflow-x-auto [&_table]:text-[14px]',
  '[&_a]:text-[14px] [&_a]:text-blue-600 [&_a]:underline hover:[&_a]:text-blue-700',
  '[&_blockquote]:text-[14px]',
  '[&_p_strong]:font-semibold [&_li_strong]:font-semibold',
  '[&_p_em]:italic [&_li_em]:italic',
  '[&_h1]:mb-2 [&_h1]:mt-4 [&_h1]:text-[16px] [&_h1]:font-semibold [&_h1]:leading-snug [&_h1]:text-[var(--brand-ink)]',
  '[&_h2]:mb-2 [&_h2]:mt-3 [&_h2]:text-[16px] [&_h2]:font-semibold [&_h2]:leading-snug [&_h2]:text-[var(--brand-ink)]',
  '[&_h3]:mb-2 [&_h3]:mt-3 [&_h3]:text-[16px] [&_h3]:font-semibold [&_h3]:leading-snug [&_h3]:text-[var(--brand-ink)]',
  '[&_h4]:mb-2 [&_h4]:mt-3 [&_h4]:text-[16px] [&_h4]:font-semibold [&_h4]:leading-snug [&_h4]:text-[var(--brand-ink)]',
  '[&_h5]:mb-1 [&_h5]:mt-2 [&_h5]:text-[16px] [&_h5]:font-semibold [&_h5]:leading-snug [&_h5]:text-[var(--brand-ink)]',
  '[&_h6]:mb-1 [&_h6]:mt-2 [&_h6]:text-[16px] [&_h6]:font-semibold [&_h6]:leading-snug [&_h6]:text-[var(--brand-ink)]',
  ...
  '[&_pre]:my-3 [&_pre]:overflow-x-auto [&_pre]:rounded-lg [&_pre]:bg-gray-50 [&_pre]:p-3 [&_pre]:text-[14px]',
