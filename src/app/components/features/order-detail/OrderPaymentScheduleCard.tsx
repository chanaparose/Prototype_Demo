    ...
    <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
      ...
      <ul className="space-y-2.5">
        {schedule.map((row) => (
          <li
            key={row.stage}
            className="flex flex-wrap items-baseline justify-between gap-2 text-sm border-b border-gray-50 pb-2 last:border-0 last:pb-0"
          >
            ...
            <span className="w-full text-xs text-gray-500 sm:w-auto sm:text-right">
