...
export const SUB_CATEGORY_PLACEHOLDERS: Record<string, string> = {
  ...
  'อาหารสุนัข':        'เช่น สูตรอะไร (Grain-free/High Protein), ช่วงวัย (Puppy/Adult/Senior), ขนาดเม็ด, มาตรฐาน (อย./GMP/HACCP)',
  'อาหารแมว':         'เช่น สูตร Indoor/Hairball, ช่วงวัย (Kitten/Adult/Senior), วัตถุดิบหลัก, มาตรฐาน (อย./GMP)',
