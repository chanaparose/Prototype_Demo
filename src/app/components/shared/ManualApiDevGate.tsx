  ...
  return (
    <div className='min-h-[calc(100vh-6rem)] flex items-center justify-center p-6 bg-brand-page'>
      <div className='max-w-md w-full rounded-2xl border border-violet-200 bg-white p-6 shadow-sm text-center space-y-4'>
        <p className='text-sm font-semibold text-brand-navy'>โหมดดู Network (dev)</p>
        ...
        <Button
          ...
          type='button'
          onClick={onLoad}
          className='w-full py-2.5 rounded-xl text-sm font-semibold text-white bg-brand-purple hover:bg-brand-purple-hover transition-colors'
        >
          โหลดข้อมูลจาก API
        </Button>
      </div>
