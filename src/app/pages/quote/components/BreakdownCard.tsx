...
export function BreakdownCard({ loading, breakdown, platformConfig }: Props) {
  ...
  if (loading) {
    return (
      <div role="status" aria-live="polite" className="rounded-2xl border border-gray-100 bg-white p-4">
  ...
  return (
    <div role="status" aria-live="polite" className="rounded-2xl border border-gray-100 bg-white p-4 space-y-2 sticky bottom-4">
      ...
      <div className="flex items-center gap-2 justify-between text-sm">
        <span className="text-gray-600">Platform Commission {breakdown.platform_commission_rate}%</span>
