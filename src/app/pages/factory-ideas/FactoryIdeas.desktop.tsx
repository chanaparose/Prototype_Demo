            ...
            >
              {CONTENT_TYPES.map((type) => (
                <button
                  ...
                  style={{
                    backgroundColor:
                      selectedType === type.id ? COLORS.orange : "transparent",
                    color:
                      selectedType === type.id ? COLORS.white : COLORS.blue,
                    fontWeight: selectedType === type.id ? 700 : 500,
                    boxShadow:
                      selectedType === type.id
                        ? "0 2px 8px rgba(227,136,68,0.35)"
                        : "none",
                  }}
                >
                  {type.label}
                      ...
                      {!menuHighlightCategoryId ? (
                        ...
                        <>
                          <button
                            type="button"
                            onClick={() =>
                              pickSubCategory(null, menuHighlightCategoryId)
                            }
