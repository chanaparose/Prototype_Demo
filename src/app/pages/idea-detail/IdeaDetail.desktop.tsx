        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4">
          <div className="space-y-3">
            <div className="flex flex-wrap items-center gap-2">
              <span className="inline-flex items-center rounded-lg px-2 py-0.5 text-[11px] font-semibold" style={{ background: '#FFF4E8', color: BRAND.orange }}>
                บทความไอเดีย
              </span>
              {item.category ? (
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-1.5">
                <p className="text-[20px] font-bold truncate" style={{ color: BRAND.ink }}>{item.factoryName}</p>
                {factory?.verified ? <BadgeCheck className="w-3.5 h-3.5 shrink-0" style={{ color: BRAND.purple }} /> : null}
              </div>
              <p className="text-[14px] text-gray-500 truncate">{factory?.specialization || 'โรงงานผู้ผลิต'}</p>
                ...
                >
                  ...
                  <div className="pt-2 mt-3 border-t border-gray-100 space-y-1.5">
                    ...
                    >
                      ...
                      {relFactory?.verified ? <BadgeCheck className="w-3 h-3 shrink-0" style={{ color: CARD.purple }} /> : null}
                    </button>
