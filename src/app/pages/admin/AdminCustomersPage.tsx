  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        {!loading && (
          <span className="text-sm text-slate-500 font-medium">{total.toLocaleString('th-TH')} คน</span>
        )}
      </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-200">
                ...
                <th className="px-4 py-3 text-left text-xs font-semibold text-slate-500 uppercase tracking-wide">ชื่อ / Email</th>
                <th className="px-4 py-3 text-right text-xs font-semibold text-slate-500 uppercase tracking-wide">ออเดอร์</th>
                <th className="px-4 py-3 text-right text-xs font-semibold text-slate-500 uppercase tracking-wide">ยอดรวม</th>
                <th className="px-4 py-3 text-right text-xs font-semibold text-slate-500 uppercase tracking-wide">Wallet</th>
                <th className="px-4 py-3 text-center text-xs font-semibold text-slate-500 uppercase tracking-wide">สถานะ</th>
              </tr>
            </thead>
              ...
              {loading ? (
                ...
                customers.map((c) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-right tabular-nums text-slate-700">{c.total_orders}</td>
