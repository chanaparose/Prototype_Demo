...
export function FactoriesListMobile({ state }: FactoriesListMobileProps) {
  ...
  const activeFilterCount = [filters.location, filters.verifiedOnly].filter(
    Boolean,
  ).length;
      ...
      <div className="bg-white px-4 pt-5 pb-4 border-b border-gray-100">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            style={{
              background:
                filterOpen || hasActiveFilters ? "#6C47FF" : "#FFFFFF",
              border:
                filterOpen || hasActiveFilters ? "none" : "1px solid #E5E7EB",
            }}
          >
            <SlidersHorizontal
              size={17}
            ...
            >
              ...
              <div className="flex items-center gap-1.5">
                <ShieldCheck
                  size={15}
                  className={
                    filters.verifiedOnly ? "text-violet-600" : "text-gray-400"
                  }
                />
                <span
                  className="text-sm"
        ...
        {factories.length === 0 ? (
          <div className="bg-white rounded-2xl border border-gray-100 p-8 text-center shadow-sm">
            ...
            <p className="text-xs text-gray-400 mt-1">
              ลองเปลี่ยนคีย์เวิร์ดหรือตัวกรอง
            </p>
          </div>
        ) : (
