...
export function FactoriesListDesktop({ state }: FactoriesListDesktopProps) {
  ...
  const hasActiveFilters =
    filters.searchText || filters.location || filters.verifiedOnly;
  const clearAll = () => {
    setSearchText("");
    setLocation("");
          ...
          <div className="flex items-center gap-2.5 flex-wrap">
            ...
            <div className="relative">
              ...
              >
                <MapPin
                  size={13}
                  className={
                    filters.location ? "text-purple-500" : "text-gray-400"
                  }
                />
            ...
            >
              <ShieldCheck
                size={13}
                className={
                  filters.verifiedOnly ? "text-purple-500" : "text-gray-400"
                }
              />
              ยืนยันแล้วเท่านั้น
            </button>
